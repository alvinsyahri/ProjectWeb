...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            <img src="/img/1.jpeg" class="card-img-top" height="300" alt="...">
    ...
    <div class="contaner">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolute px-3 py-2 text-white" style="background-color:rgba(0, 0, 0, 0.5)"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
                    <img src="/img/1.jpeg" height="250" width="100" class="card-img-top" alt="{{ $post->category->name }}">
                    <div class="card-body">
